...
export const UI = () => {
        ...
        return (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/90 z-50">
                ...
                <div className="flex flex-col gap-4">
                    <button onClick={togglePause} className="px-16 py-4 bg-cyan-500 text-black font-bold text-2xl hover:bg-cyan-400 transition-all cursor-pointer">
                        ▶ RESUME
                    </button>
                    <button onClick={restartGame} className="px-16 py-4 bg-yellow-500 text-black font-bold text-2xl hover:bg-yellow-400 transition-all cursor-pointer">
                        ↻ RESTART
                    </button>
                    <button onClick={goToMenu} className="px-16 py-4 bg-gray-600 text-white font-bold text-2xl hover:bg-gray-500 transition-all cursor-pointer">
                        ✕ QUIT
                    </button>
                </div>
            </div>
    ...
    if (gameOver) {
        return (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/90 z-50">
                ...
                <button onClick={restartGame} className="px-20 py-5 bg-cyan-500 text-black font-bold text-3xl hover:bg-cyan-400 transition-all cursor-pointer">
                    ↻ RETRY
                </button>
            </div>
        );
    ...
    // GAMEPLAY HUD - Compact Bottom-Left Stack
    return (
